        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    FK_Planner = table.Column<string>(maxLength: 450, nullable: false),
                    FK_Client = table.Column<int>(nullable: false),
                    FK_Mechanic = table.Column<string>(maxLength: 450, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assignments_FK_Category",
                table: "Assignments",
                column: "FK_Category");

            migrationBuilder.CreateIndex(
                name: "IX_Assignments_FK_Client",
                table: "Assignments",
                column: "FK_Client");

            migrationBuilder.CreateIndex(
                name: "IX_Assignments_FK_Priority",
                table: "Assignments",
                column: "FK_Priority");

            migrationBuilder.CreateIndex(
                name: "IX_Assignments_FK_Status",
                table: "Assignments",
                column: "FK_Status");
        }
